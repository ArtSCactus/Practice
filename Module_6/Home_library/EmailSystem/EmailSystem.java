...
/**
 * How this system works: There's a directory with files, which has name user
 * id+".txt Each file is a mailbox of user with id, that that name of file
 * consist This system allows to add and search mailboxes.
 *
 * @author ArtSCactus
 */
public class EmailSystem {
     ...
     * Warning: given path must be a directory(In this directory will be stored
     * mailboxes). If by this path no such directory, it will be created.
     *
     *
     */
